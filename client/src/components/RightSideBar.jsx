...
const RightSideBar = () => {
  ...
  return activeChat && (
    <div className={`bg-[#8185B2]/7 text-white w-full relative overflow-y-scroll ${activeChat ? "max-md:hidden" : ""}`}>
      ...
      <div className='absolute bottom-5 left-1/2 transform -translate-x-1/2 flex w-[85%] gap-2'>
        {chatType === 'group' && (
          <button
